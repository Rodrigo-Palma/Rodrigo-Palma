            ...
            <div className="col-lg-7 ml-auto">
              <div className="about-info">
                ...
                <div className="about-text">
                  <p>
                    I'm an enthusiast in the field of Data Science, ready to take on enriching challenges. 
                    I am committed to honing my data analysis skills to contribute to remarkable companies 
                    and projects on a global scale. I'm excited to collaborate with talented teams 
                    and embrace new opportunities in this thrilling realm of data.
                  </p>
                  <p>
